angular.module('starter', ['ionic', 'starter.services', 'starter.controllers', 'ngStorage'])
  ...
  .run(function ($ionicPlatform, $rootScope, $ionicHistory, $ionicLoading, $localStorage, $location, $filter, Location) {
    $rootScope.hostMail = 'https://www.solutioneden.com/active.php';
    $rootScope.keyMap = 'AIzaSyDX5gcWp-Pcm0TWBq3YmRuQK_yaX9CxO7k';
    $rootScope.getMap = 'https://maps.googleapis.com/maps/api/staticmap?key=' + $rootScope.keyMap + '&';
    $rootScope.linkDownload = '#';
